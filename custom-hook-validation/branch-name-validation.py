...
def validate_branch_name(branch_name):
    ...
    if not re.match(pattern, branch_name):
        print(f"Error: Branch name '{branch_name}' is invalid. It must follow the pattern (feature|bugfix|hotfix|release|docs|chore|prepare) 'type/description'. Use git branch -M to rename the branch.")
        sys.exit(1)
